...
execute_process(
  COMMAND "/usr/bin/git" show-ref 51143d5b62521f71020ada4ba1b6b44f3a6749bb
  WORKING_DIRECTORY "/home/sammers21/Desktop/shersh_gtest_template/ext/gtest/src/googletest"
...
if("${show_ref_output}" MATCHES "refs/remotes/51143d5b62521f71020ada4ba1b6b44f3a6749bb")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "51143d5b62521f71020ada4ba1b6b44f3a6749bb")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "51143d5b62521f71020ada4ba1b6b44f3a6749bb")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 51143d5b62521f71020ada4ba1b6b44f3a6749bb
  WORKING_DIRECTORY "/home/sammers21/Desktop/shersh_gtest_template/ext/gtest/src/googletest"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/sammers21/Desktop/shersh_gtest_template/ext/gtest/src/googletest/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/sammers21/Desktop/shersh_gtest_template/ext/gtest/src/googletest/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout 51143d5b62521f71020ada4ba1b6b44f3a6749bb
      WORKING_DIRECTORY "/home/sammers21/Desktop/shersh_gtest_template/ext/gtest/src/googletest"
      RESULT_VARIABLE error_code
      )
    if(error_code)
